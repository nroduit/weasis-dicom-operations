...
public class TagElement {
    ...
    public static final TagElement WadoTransferSyntaxUID = new TagElement("Wado Transfer Syntax UID", TagType.String);

    public static final TagElement TransferSyntaxUID =
        new TagElement(0x00020010, "Transfer Syntax UID", TagType.String);

    public static final TagElement PatientName = new TagElement(0x00100010, "Patient Name", TagType.String);
    public static final TagElement PatientID = new TagElement(0x00100020, "PatientID", TagType.String);
    public static final TagElement PatientBirthDate = new TagElement(0x00100030, "Patient Birth Date", TagType.Date);
    public static final TagElement PatientBirthTime = new TagElement(0x00100032, "Patient Birth Time", TagType.Time);
    public static final TagElement PatientSex = new TagElement(0x00100040, "Patient Sex", TagType.String);

    public static final TagElement StudyInstanceUID = new TagElement(0x0020000D, "Study Instance UID", TagType.String);
    public static final TagElement SeriesInstanceUID =
        new TagElement(0x0020000E, "Series Instance UID", TagType.String);
    public static final TagElement StudyID = new TagElement(0x00200010, "Study ID", TagType.String);
    public static final TagElement InstanceNumber = new TagElement(0x00200013, "Instance Number", TagType.Integer);
    public static final TagElement ImageOrientationPatient = new TagElement(0x00200037, "Image Orientation",
        TagType.DoubleArray);
    public static final TagElement SliceLocation = new TagElement(0x00201041, "Slice Location", TagType.Float);

    public static final TagElement SeriesDescription = new TagElement(0x0008103E, "Series Description", TagType.String);
    public static final TagElement SeriesNumber = new TagElement(0x00200011, "Series Number", TagType.Integer);
    public static final TagElement SOPInstanceUID = new TagElement(0x00080018, "SOP Instance UID", TagType.String);
    public static final TagElement StudyDate = new TagElement(0x00080020, "Study Date", TagType.Date);
    public static final TagElement SeriesDate = new TagElement(0x00080021, "Series Date", TagType.Date);
    public static final TagElement StudyTime = new TagElement(0x00080030, "Study Time", TagType.Time);
    public static final TagElement AcquisitionTime = new TagElement(0x00080032, "Acquisition Time", TagType.Time);
    public static final TagElement AccessionNumber = new TagElement(0x00080050, "Accession Number", TagType.String);
    public static final TagElement Modality = new TagElement(0x00080060, "Modality", TagType.String);
    public static final TagElement ReferringPhysicianName = new TagElement(0x00080090, "Referring Physician Name",
        TagType.String);
    public static final TagElement StudyDescription = new TagElement(0x00081030, "Study Description", TagType.String);
